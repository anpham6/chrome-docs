...
- `Firestore Client API <https://googleapis.dev/nodejs/firestore/latest>`_
...
- `BigQuery Client API <https://googleapis.dev/nodejs/bigquery/latest>`_
...
- `Datastore Client API <https://googleapis.dev/nodejs/datastore/latest>`_
...
- `Bigtable Client API <https://googleapis.dev/nodejs/bigtable/latest>`_
...
- `Spanner Client API <https://googleapis.dev/nodejs/spanner/latest>`_
...
- `Realtime Database Client API <https://firebase.google.com/docs/reference/js/database.md#database_package>`_
