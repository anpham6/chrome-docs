...
.. note:: Uses :doc:`S3 <aws>` [#]_ compatibility API :alt:`(AWS v2)` and signature **iam**.
...
.. versionadded:: 0.3.0
  ...
  - NPM: Unmaintained and untested source with :alt:`@ibm-cloud/cloudant 0.12.9` was released.
...
.. [#] https://github.com/anpham6/pi-r2/tree/master/src/cloud/ibm