...
.. code-block:: typescript
  ...
  interface RedisDataSource extends DbDataSource {
      ...
      update?: {
          ...
          command?: "DEL" | "FORGET" | "MERGE" | "MSET" | "NUMINCRBY" | "NUMMULTBY" | "SET" | "STRAPPEND" | "STRLEN"; // Default is "SET"

          command?: "ARRAPPEND" | "ARRINDEX" | "ARRINSERT" | "ARRLEN" | "ARRPOP" | "ARRTRIM";
          start?: number;
          stop?: number;
          index?: number;
      };
...
.. versionadded:: 0.13.0
  ...
  - *NPM* package **redis** was upgraded from *5.1* to :target:`6.0` with a :alt:`NodeJS 20` requirement.
  - *RedisClientOptions* property **RESP** can be globally set through **NODE_REDIS_CLIENT_RESP** as :alt:`2 | 3` for all client connections.
  - *RedisJSONValue* property **command** as types ":lower:`ARRLEN`" | ":lower:`STRLEN`" were implemented.
