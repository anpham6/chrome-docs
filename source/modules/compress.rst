...
.. versionremoved:: 0.14.0
  ...
  - *ICompress* compression format **zopfli** as :alt:`gzip` is no longer supported.
...
.. versionadded:: 0.14.0
  ...
  - *CompressModule* settings for **Zstandard** compression format :alt:`(experimental)` is supported.
