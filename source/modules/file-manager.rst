...
.. code-block::
  ...
  interface FileManagerConstructor extends HostConstructor {
      ...
      purgeMemory(percent?: number, limit?: number, parent?: number | boolean): Promise<number>;
...
.. versionadded:: 0.14.1
  ...
  - *ExternalAsset* property **headers** as :alt:`OutgoingHttpHeaders` was implemented.

.. versionchanged:: 0.14.1

 - *IRequest* :alt:`OpenOptions` property **headers** with an :target:`Authorization` request header is no longer cached without a :ref:`Cache-Control <references-mdn-cache-control>` response header.
